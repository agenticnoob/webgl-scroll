...
- `@webgl-scroll/effects`: built-in visual effects such as `asset-layer`, `fade-title`, and `pixelated-wipe`.
...
4. Put scanning, timing, state, router, and renderer mechanics in `@webgl-scroll/core`.
