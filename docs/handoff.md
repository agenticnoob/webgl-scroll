...
- Optimize `glb-particles` internals before broadening the API: split pointer mapping, material creation, transform application, and simulation stepping out of `GlbParticlesEffect.update()`.
