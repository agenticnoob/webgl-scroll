---
name: webgl-scroll
description: Use when integrating DOM-driven WebGL scroll effects, choosing @webgl-scroll effects, wiring React or Next.js adapters, creating custom defineWebGLEffect plugins, or migrating legacy data-webgl-role markup.
---
...
3. Choose built-in effects from `references/effects.md` before adding a custom `defineWebGLEffect()` plugin.
...
- Pass effects to `createWebGLScrollRuntime()` or `<WebGLScrollRuntime />` before starting the engine.
